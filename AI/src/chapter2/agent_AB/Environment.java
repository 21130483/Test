...
public class Environment {
	...
	public EnvironmentState executeAction(Action action) {
		if(action==SUCK_DIRT) {
			...
			if(envState.getAgentLocation()==Environment.LOCATION_B) {
			...
			if(envState.getAgentLocation()==Environment.LOCATION_D) {
				envState.setAgentLocation(LOCATION_A);
			}else {
				envState.setAgentLocation(LOCATION_B);
			}
	...
	public Percept getPerceptSeenBy() {
		String al =envState.getAgentLocation();
		return new Percept(al,envState.getLocationState(al));
	}
